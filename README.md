Template forked from [ai-folio template](https://github.com/alshedivat/al-folio).

The "Publication" section was adapted from [this fork](https://github.com/eaplatanios/eaplatanios.github.io)  
